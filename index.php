	...
	<center><h2>Login page</h2></center>
		...
		<form action="index.php" method="post"  onsubmit="return validate(this);">
			...
			<div class="inner_container">
				...
				<div class="btngrp"><button class="login_button" name="login" type="submit"  color="#000000">Login</button>
		          
				<h3><div class="register_div"><a href="register.php" class="register_link"><span><br>Register</span></a></div></h3>
			</div></br>
		</form>
